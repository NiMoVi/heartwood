...
- [x] 02-02-PLAN.md — Rewrite PROJECTS array with 5 real entries: 3 anonymized Deloitte case studies + 2 personal tools (Wave 1)
- [x] 02-03-PLAN.md — Build About screen with bio narrative, trilingual callout, cert grid, resume download; wire nav (Wave 2)
- [x] 02-04-PLAN.md — Strip Contact form, replace with social link grid; update headline and body copy (Wave 2)
- [x] 02-05-PLAN.md — Wire Footer social icons to real URLs via SOCIAL map; confirm LinkedIn slug (Wave 3)

---

### Phase 3: Polish & Deploy
**Goal:** The site is publicly live at `https://nimovi.github.io/heartwood-NicoMora/`, renders correctly on mobile, and produces a proper link preview when shared on LinkedIn or Slack.
**Depends on:** Phase 2
**Requirements:** DEPLOY-01, DEPLOY-02, DEPLOY-03
**UI hint**: yes

**Note:** Git remote is `NiMoVi/heartwood-NicoMora` (not `heartwood`). Live URL will be `https://nimovi.github.io/heartwood-NicoMora/` unless repo is renamed before Pages activation.

**Success Criteria:**
1. Visiting the confirmed live URL in a browser loads the portfolio with no 404 errors and no broken assets
...
Plans:
- [ ] 03-01-PLAN.md — Enable GitHub Pages: create .nojekyll (DONE), activate via Settings UI (PENDING human-action checkpoint) (Wave 1)
...
*Plans added: 2026-06-03 (Phase 3 — 3 plans, 2 waves)*
