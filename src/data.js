...
const PROJECTS = [
  ...
  // ── CONS-03: State Lottery Cloud Migration ────────────────────────────────
  {
    ...
    body: [
      ...
      'Delivery came in significantly ahead of projected timelines, with minimal disruption to reporting operations during the transition. The sequencing strategy of prioritizing by report impact rather than migrating object-by-object was the key factor in the clean handoff.',
    ],
